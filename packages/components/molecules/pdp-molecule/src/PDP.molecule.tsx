...
export const PDPMolecule: FC<PDPMoleculeProps> = ({
	...
	return (
		<div >
			...
			<div className='flex relative justify-center lg:right-14 lg:bottom-10'> <ButtonCTA title={'add to cart'}/> </div>
			<div>
			...
			<div className='mb-10 flex relative justify-center lg:justify-start'> <ButtonCTA title={'shop all'} color={'gray-50'} fontColor={'gray-500'}/> </div>
		</div>
	);
};
