...
export const AddProduct = ({ onClick }: AddProductProps): JSX.Element => {
	return (
			...
			<div className='add-product-modal w-full'>
				<form className=''>
					...
					<div className='flex flex-col lg:flex-row lg:gap-x-2 mx-auto mb-4'>
						<TextInput placeholder='Price' type='product-price' css='mb-2' />
						<TextInput placeholder='Size' type='product-size' css='mb-2' />
						<TextInput placeholder='Color' type='product-color' css='mb-2' />
						<TextInput placeholder='Scent' type='product-scent' css='mb-2' />
					</div>
					<div className='flex justify-end -mt-4 mb-6'>
						<h3 className='underline text-gray-600 text-sm'>
							Add Another Variant
						</h3>
					</div>
					<div className='flex flex-col lg:flex-row'>
						...
						<div className='mx-auto'>
							<h3 className='mx-auto text-gray-600 text-center'>
								Upload Up To 5 Images
							</h3>
							<div className='flex flex-row gap-x-3'>
								<div className='border-2 border-dashed h-20 w-20 text-xs my-2 pt-20 bg-white' />
								<div className='border-2 border-dashed h-20 w-20 text-xs my-2 pt-20 bg-white' />
								<div className='border-2 border-dashed h-20 w-20 text-xs my-2 pt-20 bg-white' />
							</div>
							<div className='flex flex-row gap-x-3'>
