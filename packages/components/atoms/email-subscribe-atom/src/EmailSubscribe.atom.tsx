	...
	return (
		<div className='email-subscribe-section flex flex-col lg:flex-row w-full m-auto'>
			<div className='flex flex-col w-1/2'>
				<img alt='email header' src='/images/ETHX-Header-Mask.jpg' />
			</div>
			<div className='flex flex-col text-xl w-1/2 py-32'>
				<h3 className='text-primary my-3 w-3/5 mx-auto text-center'>
					Stay in the loop on all things ethx: new launches, promotions and
					more!{' '}
				</h3>
				<form className='w-3/5 mx-auto flex flex-col lg:flex-row'>
					<TextInput
